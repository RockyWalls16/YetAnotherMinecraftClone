...
public:
	...
	static bool isSideVisible(shared_ptr<AirChunk> chunk, Block* blockId, int x, int y, int z, Side faceSide);

	static bool shallRenderFace(shared_ptr<AirChunk> chunk, Block* blockId, int x, int y, int z, Side faceSide);
